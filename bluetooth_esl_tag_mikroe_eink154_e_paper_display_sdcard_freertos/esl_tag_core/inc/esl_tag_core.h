 ...
 *****************************************************************************/
#define                                                                            \
                                              esl_core_get_id(addr_word)        (( \
                                       esl_id_t)(addr_word & ESL_ID_MASK))
 ...
 *****************************************************************************/
#define                                                                            \
                                              esl_core_get_group_id(addr_word)  (( \
                                       esl_group_id_t)                             \
 ...
 * *(uint8_t*)ap_key in a format of little endian (packed) byte stream or as
 * psa_key_id_t if PSA Crypto / TrustZone key storage is used.
 * Size of the plain text (stream) format is defined in Core specification v5.4,
 * Vol 3, Part C, 12.6 ENCRYPTED DATA KEY MATERIAL, Table 12.10 Key material fmt
 *
