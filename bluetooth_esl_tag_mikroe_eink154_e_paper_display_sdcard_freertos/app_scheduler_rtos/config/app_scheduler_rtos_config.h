...
// <q APP_SCHEDULER_ENABLE> Running task handler on bluetooth thread
// <i> Running task handler on bluetooth thread.
#define APP_SCHEDULER_TASK_HANDLER_ON_BT_THREAD 1

// <q APP_SCHEDULER_ENABLE> Task handler external signal id
// <i> Task handler external signal id.
#define APP_SCHEDULER_BT_EVENT_EXT_SIGNAL_ID    1
...
// <0-65535:1>
#define APP_SCHEDULER_MAX_DATA_SIZE             18
