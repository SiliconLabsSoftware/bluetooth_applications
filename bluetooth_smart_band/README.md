...
![Flash badge](https://img.shields.io/badge/Flash-200.68%20KB-blue)
![RAM badge](https://img.shields.io/badge/RAM-14.35%20KB-blue)
...
- [DT78 Android app](#dt78-android-app)
...
- [DT78-App-Android](https://github.com/fbiego/DT78-App-Android)
...
DT78 Android app is a reverse-engineered Android app that reads app notifications on Android and sends them via BLE for WSTK to receive. For more details, check [this link](https://github.com/fbiego/DT78-App-Android).
...
1. First, the software initializes the peripherals, and the Bluetooth stack, and enables logging to the virtual COM port.
   ...
   ![Flow diagram](image/work_flow_1.png)
