...
![Flash badge](https://img.shields.io/badge/Flash-201.74%20KB-blue)
![RAM badge](https://img.shields.io/badge/RAM-19.15%20KB-blue)
...
- [How It Works](#how-it-works)
  ...
  - [Start/Stop the HRM/SpO2 Measurement](#startstop-the-hrmspo2-measurement)
  - [Proximity Mode](#proximity-mode)
  - [Use Simplicity Connect Mobile Application](#use-simplicity-connect-mobile-application)
  - [USB Debug Mode](#usb-debug-mode)
- [Special Note](#special-notes)
...
3. Import the GATT configuration:
   ...
   - Find the Import button and import the configuration `bluetooth_explorer_kit_i2c_bio_sensor/config/btconfig/gatt_configuration.btconf` file.
...
Users can launch the Console that is integrated on Simplicity Studio or can use a third-party terminal tool like Tera Term to receive the data from the USB. A screenshot of the console output is shown in the figure below.
